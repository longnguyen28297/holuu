    ...
    <div class="row">
        ...
        <div class="col-md-8 small-section">
            <div class="post-item-tc clearfix">
                <div class="img-thumb">
                    <a href="{{asset('chi-tiet')}}/{{$topic_first->slug}}"><img src="{{asset('images')}}/{{$topic_first->images}}" class="img-fluid"
                            ...
                            <li class="post-item-small">
                                <div class="row">
                                    <div class="col-md-4 col-xs-3">
                                        <div class="img-thumb">
                                            <a href="{{asset('chi-tiet')}}/{{$topic->slug}}"><img src="{{asset('images')}}/{{$topic->images}}" class="img-fluid"
                                                alt=""></a>
                                            </div>
                                        </div>
            ...
            <section>
                <div class="row slider">
                    ...
                    <div class="col-md-12"><img width="100%" src="{{asset('images/banner')}}/{{$banner_slider->images}}" alt=""></div>
                    @endif
                    ...
                    <div class="col-md-6 ">
                        <div class="main-new">
                            ...
                            <div class="post-item-main clearfix">
                                <div class="img-thumb">
                                    <a href="{{asset('chi-tiet')}}/{{$topicFTags_first->slug}}"><img src="{{asset('images')}}/{{$topicFTags_first->images}}" class="img-fluid"
                            ...
                            <section>
                                <div class="main-new">
                                    ...
                                    foreach ($topicFTags as $topic){
                                        ?>
                                        <div class="item"><a href="{{asset('chi-tiet')}}/{{$topic->slug}}"><img src="{{asset('images')}}/{{$topic->images}}" alt="">
                                            <p>{{$topic->title}}</p>
                                        </a></div>
                                    <?php } ?>
                                </div>
